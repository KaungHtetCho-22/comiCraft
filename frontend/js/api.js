...
const API_BASE_URL = window.COMIC_API_BASE || (
...
class ComicAPI {
     ...
     */
    static async generateComic(apiKey, prompt, pageCount, baseUrl, model, comicStyle = 'doraemon', language = 'en', rowsPerPage = 4, googleApiKey = null, continuationContext = null) {
        try {
     ...
     */
    static async generateComicImage(pageData, googleApiKey, referenceImg = null, extraBody = null, comicStyle = 'doraemon', rowsPerPage = null, language = 'en') {
        try {
     ...
     */
    static async optimizePrompt(apiKey, googleApiKey, prompt, baseUrl, model, comicStyle = 'doraemon', language = 'en') {
        try {
     ...
     */
    static async generateSessionTitle(apiKey, googleApiKey, prompt, comicData = null, baseUrl = 'https://api.openai.com/v1', model = 'gpt-4o-mini', language = 'en') {
        try {
